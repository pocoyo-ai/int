...
<html lang="es">
  <head>
    ...
    <title>Macrosoft - Contacto</title>
    ...
    <nav class="navbar navbar-expand-lg bg-light navbar-light">
        <div class="container">
            ...
            <li class="nav-item dropdown">
                ...
                <li><a class="dropdown-item active" href="contact.php">Soporte técnico</a></li>
                </ul>
            </li>
            </ul>
            </div>
    ...
    <section class="text-center dark-grey-text">
      <div class="card">
        <div class="card-body rounded-top border-top p-5">
          <h3 class="font-weight-bold my-4">Contáctanos</h3>
          <p class="font-weight-light mx-auto mb-4 pb-2">Plantéanos cualquier duda o inquietud.<br>Responderemos lo más breve posible.</p>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group mb-4">
                  <textarea class="form-control rounded" id="message" rows="3" placeholder="¿Cómo te ayudamos?"></textarea>
                </div>
